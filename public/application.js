...
var config = {
  apiOrigins: {
    ...
    production: 'https://happy-hut.herokuapp.com'
  }
};
...
var addNestedValue = __webpack_require__(7);
...
var _decorators = __webpack_require__(153);

var _logger = __webpack_require__(155);
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<form id=\"sign-up\" class=\"logged-out\">\n  <fieldset>\n    <legend>Create an Account</legend>\n    <input type=\"text\" name=\"credentials[email]\" placeholder=\"Enter Email\"> <br/>\n    <input type=\"password\" name=\"credentials[password]\" placeholder=\"Enter Password\"> <br/>\n    <input type=\"password\" name=\"credentials[password_confirmation]\" placeholder=\"Confirm Password\"> <br/>\n    <input type=\"submit\" name=\"submit\" value=\"Sign up\">\n  </fieldset>\n</form>\n<form id=\"sign-in\">\n  <fieldset>\n    <legend>Sign In</legend>\n    <input type=\"text\" name=\"credentials[email]\" placeholder=\"Enter Email\"><br/>\n    <input type=\"password\" name=\"credentials[password]\" placeholder=\"Enter Password\"><br/>\n    <input type=\"submit\" name=\"submit\" value=\"Sign in\">\n  </fieldset>\n</form>\n";
},"useData":true});
...
var createChore = function createChore(data) {
  return $.ajax({
...
var destroyChore = function destroyChore(data) {
  return $.ajax({
...
var getOneChore = function getOneChore(data) {
  return $.ajax({
    url: config.apiOrigin + '/chores/' + data,
    method: 'GET',
    headers: {
...
var getAllChores = function getAllChores() {
  return $.ajax({
    url: config.apiOrigin + '/chores',
    method: 'GET',
    headers: {
...
module.exports = {
  ...
  destroyChore: destroyChore,
  updateChore: updateChore,
  getOneChore: getOneChore
};
...
var store = __webpack_require__(3);
var displayAllChores = __webpack_require__(160);

var messageHUD = function messageHUD(txt, time) {
  $('#app-hud').text('' + txt);
...
var renderTemplate = function renderTemplate(selector, data) {
  var html = displayAllChores({ chores: data });
  $(selector).html(html);
};

var createChoreSuccess = function createChoreSuccess(data) {
  store.chores.push(data.chore);
  messageHUD('New Chore Created', 8000);
};

var createChoreFailure = function createChoreFailure() {
  // console.log('createChoreFailure')
  messageHUD('Could not create a chore', 10000);
};

var getAllChoresSuccess = function getAllChoresSuccess(data) {
...
var toogleVisibilty = function toogleVisibilty() {
  ...
  var choreIDstring = '#' + clickedId;
  $(choreIDstring).toggleClass('editable');
  var updateID = '#update-inplace-' + clickedId;
  // console.log(updateID)
  $(updateID).toggleClass('visible');
};

module.exports = {
  createChoreSuccess: createChoreSuccess,
  createChoreFailure: createChoreFailure,
  getAllChoresSuccess: getAllChoresSuccess,
  getAllChoresFailure: getAllChoresFailure,
  updateChoreSuccess: updateChoreSuccess,
  updateChoreFailure: updateChoreFailure,
  destroyChoreSuccess: destroyChoreSuccess,
  destroyChoreFailure: destroyChoreFailure,
...
var setAPIOrigin = __webpack_require__(138);
var config = __webpack_require__(5);
var authEvents = __webpack_require__(140);
var choresEvents = __webpack_require__(161);
var displayLoginAuth = __webpack_require__(10);
...
$(function () {
  ...
  var userLoginHTML = displayLoginAuth();
...
var parseNestedQuery = __webpack_require__(139);
...
var authAPI = __webpack_require__(141);
var authUI = __webpack_require__(142);
var choresAPI = __webpack_require__(11);
var choresUI = __webpack_require__(12);
...
var onSignUp = function onSignUp(event) {
  ...
  authAPI.signUp(data).then(authUI.signUpSuccess).catch(authUI.signUpFailure);
...
var onSignIn = function onSignIn(event) {
  ...
  authAPI.signIn(data).then(authUI.signInSuccess).then(choresAPI.getAllChores).then(choresUI.getAllChoresSuccess).catch(authUI.signInFailure);
...
var store = __webpack_require__(3);
var displayUserAuth = __webpack_require__(143);
var displayLoginAuth = __webpack_require__(10);

var eraseHUD = function eraseHUD(time) {
  window.setTimeout(function () {
    $('#app-hud').text('');
  }, time);
};
...
var signInSuccess = function signInSuccess(data) {
  ...
  eraseHUD(8000);
  var userAdminHTML = displayUserAuth();
...
var changePasswordFailure = function changePasswordFailure(data) {
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<form id=\"change-password\" >\n  <fieldset>\n    <legend>Change Password</legend>\n    <input type=\"password\" name=\"passwords[old]\" placeholder=\"Old Password\"><br/>\n    <input type=\"password\" name=\"passwords[new]\" placeholder=\"New Password\"><br/>\n    <input type=\"submit\" name=\"submit\" value=\"Change Password\">\n  </fieldset>\n</form>\n<form id=\"sign-out\">\n  <fieldset>\n    <legend>Sign Out</legend>\n    <input type=\"submit\" name=\"submit\" value=\"Sign Out\">\n  </fieldset>\n</form>\n\n<form id=\"create-chore\">\n  <fieldset>\n    <legend>\n      Create a Chore\n    </legend>\n    <input type=\"text\" name=\"chore[chore_name]\" placeholder=\"Name\"/><br/>\n    <input type=\"number\" name=\"chore[chore_interval]\" placeholder=\"Interval (In Days)\"/><br/>\n    <input type=\"date\" name=\"chore[last_done]\" placeholder=\"Last Done\"/><br/>\n    <input type=\"text\" name=\"chore[over_due]\" placeholder=\"Over due\"/><br/>\n    <button type=\"submit\">Add</button>\n  </fieldset>\n</form>\n<!-- <form id=\"update-chore\">\n  <fieldset>\n    <legend>\n      Change a Chore\n    </legend>\n    <input type=\"text\" name=\"chore[id]\" placeholder=\"Chore ID\"/><br/>\n    <input type=\"text\" name=\"chore[chore_name]\" placeholder=\"Name\"/><br/>\n    <input type=\"number\" name=\"chore[chore_interval]\" placeholder=\"Interval (In Days)\"/><br/>\n    <input type=\"date\" name=\"chore[last_done]\" placeholder=\"Last Done\"/><br/>\n    <input type=\"text\" name=\"chore[over_due]\" placeholder=\"Over due\"/><br/>\n    <button type=\"submit\">Update</button>\n  </fieldset> -->\n</form>\n";
},"useData":true});
...
var _handlebarsSafeString = __webpack_require__(156);
...
var _handlebarsRuntime = __webpack_require__(157);

var runtime = _interopRequireWildcard(_handlebarsRuntime);

var _handlebarsNoConflict = __webpack_require__(158);
...
var _helpersBlockHelperMissing = __webpack_require__(146);

var _helpersBlockHelperMissing2 = _interopRequireDefault(_helpersBlockHelperMissing);

var _helpersEach = __webpack_require__(147);

var _helpersEach2 = _interopRequireDefault(_helpersEach);

var _helpersHelperMissing = __webpack_require__(148);

var _helpersHelperMissing2 = _interopRequireDefault(_helpersHelperMissing);

var _helpersIf = __webpack_require__(149);

var _helpersIf2 = _interopRequireDefault(_helpersIf);

var _helpersLog = __webpack_require__(150);

var _helpersLog2 = _interopRequireDefault(_helpersLog);

var _helpersLookup = __webpack_require__(151);

var _helpersLookup2 = _interopRequireDefault(_helpersLookup);

var _helpersWith = __webpack_require__(152);
...
var _decoratorsInline = __webpack_require__(154);
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n<div id=\""
    ...
    + "\">\n  <h1> "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.chore_name : stack1), depth0))
    + "\n    <div class=\"btn-group btn-group-sm\" role=\"group\" >\n      <button class=\"btn btn-default btn-sm update-chore\" type=\"button\" data-id="
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + ">\n        update\n      </button>\n      <button class=\"btn btn-default btn-sm delete-chore\" type=\"button\" data-id="
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + ">\n        delete\n      </button>\n      <button class=\"btn btn-default btn-sm finish-chore\" type=\"button\" data-id="
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + ">\n        done\n      </button>\n    </div>\n  </h1>\n  <p id=\"update-static-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n    chore id: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + " <br />\n    interval: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.chore_interval : stack1), depth0))
    + " <br />\n    last done on: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.last_done : stack1), depth0))
    + " <br />\n    over due: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.over_due : stack1), depth0))
    + " <br />\n  </p>\n  <form id=\"update-inplace-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"visible update-chore-form\">\n    <fieldset>\n      chore id: <input class=\"unselectable\" type=\"text\" name=\"chore[id]\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" readonly/><br/>\n      interval: <input type=\"number\" name=\"chore[chore_interval]\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.chore_interval : stack1), depth0))
    + "\"/><br/>\n      last done on: <input type=\"date\" name=\"chore[last_done]\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.last_done : stack1), depth0))
    + "\"/><br/>\n      over due: <input type=\"text\" name=\"chore[over_due]\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.over_due : stack1), depth0))
    + "\"/><br/>\n      <input type=\"submit\"/>\n      <!-- <input type=\"radio\" id=\"contactChoice1\"\n       name=\"contact\" value=\"email\">\n      <label for=\"contactChoice1\">Email</label>\n\n      <input type=\"radio\" id=\"contactChoice2\"\n       name=\"contact\" value=\"phone\">\n      <label for=\"contactChoice2\">Phone</label> -->\n    </fieldset>\n  </form>\n</div>\n\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.chores : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
var appLogic = __webpack_require__(164);
...
var createChore = function createChore(event) {
  ...
  // console.log(data)
  event.preventDefault();
  choresAPI.createChore(data).then(choresUI.createChoreSuccess).then(choresAPI.getAllChores).then(choresUI.getAllChoresSuccess).then(appLogic.checkOverDue).catch(choresUI.updateChoreFailure);
  $('#create-chore').find('input, select, textarea').val('');
};

var changeChore = function changeChore(event) {
  var data = getFormFields(this);
  // console.log('data ::', data)
  event.preventDefault();
  choresAPI.updateChore(data).then(choresUI.updateChoreSuccess).then(choresAPI.getAllChores).then(choresUI.getAllChoresSuccess).then(choresUI.renderTemplate('#show-chores', store.chores)).then(appLogic.checkOverDue).catch(choresUI.updateChoreFailure);
  $('#update-chore').find('input, select, textarea').val('');
};

var deleteChore = function deleteChore() {
  var choreID = $(this).attr('data-id');

  choresAPI.destroyChore(choreID).then(choresUI.destroyChoreSuccess).then(choresAPI.getAllChores).then(choresUI.getAllChoresSuccess).catch(choresUI.destroyChoreFailure);
};

var finishChore = function finishChore() {
  var choreID = $(this).attr('data-id');
  // choreID val is coerced in to an INT with precceding "+"
  var choreObject = store.chores.find(function (item) {
    return item.id === +choreID;
  });

  var currentDate = moment();
  var alteredDate = moment().add(choreObject.chore_interval, 'days');
  ...
  var chore = choreObject;
  chore.id = +choreID;
  chore.last_done = currentDate.format('YYYY-MM-DD');
  chore.over_due = false;

  var data = { chore: chore
    // console.log('NEW objechorect ::', data)

  };choresAPI.updateChore(data).then(choresUI.updateChoreSuccess(alteredDate)).then(choresAPI.getAllChores).then(choresUI.getAllChoresSuccess).then(appLogic.checkOverDue).catch(choresUI.destroyChoreFailure);
};
...
var checkOverDue = function checkOverDue() {
  // console.log('check over due')
  var allChores = store.chores;
  var currentDate = moment();

  allChores.forEach(function (chore) {
    var dueDate = moment(chore.last_done).add(chore.chore_interval, 'days');
...
var update = __webpack_require__(172)(content, options);
...
var	fixUrls = __webpack_require__(173);
